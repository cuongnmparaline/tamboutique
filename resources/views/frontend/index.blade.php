...
@section('title','Tâm Boutique || Trang Chủ')
                                        ...
                                        <div class="product-img">
                                            ...
                                            <div class="button-head">
                                                ...
                                                <div class="product-action-2">
                                                    <a title="Add to cart" onclick="addCart({{$product->id}})" href="javascript:">Thêm vào giỏ hàng</a>
                                                </div>
                                            </div>
                                        </div>
        ...
        function addCart(id) {
            $.ajax({
                ...
                success:function(data) {
                    let cartCount = parseInt($(".total-count-cart").html());
                    cartCount++;
                    $(".total-count-cart").html(cartCount);
                    alertify.defaults = {
                        // dialogs defaults
                        autoReset:true,
                        basic:false,
                        ...
                        glossary:{
                            ...
                            // ok button text
                            ok: "<a href='{{route('cart')}}'>Đi đến giỏ hàng</a>",
                            // cancel button text
                    ...
                    alertify.confirm("Thêm sản phẩm vào giỏ hàng thành công!",
                        function(){
                            alertify.error;
                        },
                        function(){
