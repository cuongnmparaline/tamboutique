...
@section('title','Tâm Boutique || Thanh Toán')
                                ...
                                <div class="single-widget">
                                    ...
                                    <div class="content">
                                        <ul>
                                            ...
                                            @endif
                                            @error('shipping')
                                            <li class="last"><span class='text-danger'>{{$message}}</span></li>
                                            @enderror
                                        </ul>
                                    </div>
                                ...
                                <div class="single-widget">
                                    ...
                                    <div class="content">
                                        <div class="checkbox">
                                            ...
                                            <form-group>
                                                <input name="payment_method" type="radio" value="cod" checked> <label> Thanh Toán Khi Giao Hàng</label><br>
                                                <input name="payment_method" type="radio" value="vnpay"> <label> Thanh Toán Online</label><br>
