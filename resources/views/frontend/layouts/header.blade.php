                    ...
                    <div class="right-bar">
                        ...
                        <div class="sinlge-bar shopping">
                           ...
                           @if(session('wishlist'))
                                ...
                                @endforeach
                           @endif
                            <a href="{{route('wishlist')}}" class="single-icon"><i class="fa fa-heart-o"></i> <span class="total-count-wishlist">{{Helper::wishlistCount()}}</span></a>
                            <!-- Shopping Item -->
                            @auth
                        ...
                        <div class="sinlge-bar shopping">
                            <a href="{{route('cart')}}" class="single-icon"><i class="ti-bag"></i> <span class="total-count-cart">{{Helper::cartCount()}}</span></a>
                            <!-- Shopping Item -->
                            @auth
                                <div class="shopping-item">
                                    <div class="dropdown-cart-header">
